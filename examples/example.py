...
memory_manager.update_memory(user_id, "We have young girl named Lisa and I'm married to my wife Gabby")
...
context = memory_manager.get_memory_context(user_id, message="there is a new basketball court in the park")
print(context)
